...
- `infra_policy_names` - List of non-mandatory Infra Policy names (as configured)
...
- `storage_classes_initial_class_config_overrides` - (**Deprecated**) Same as `storage_classes_class_config_overrides`; use that attribute instead
...
- `zones_initial_class_config_overrides` - (**Deprecated**) Same as `zones_class_config_overrides`; use that attribute instead
